...
if __name__=="__main__":
    ...
    url="http://www.niyamasabha.nic.in/index.php/contact/contact_legislature_secretariat"
    ...
    for ele in get_individuals:
        ...
        source_data = htmlhelper.collecturl(ele,"<td height=\"1\" width=\"293\">","</td>")
        print(source_data)
        for go in source_data:
                ...
                d = {
                        ...
                        "source": {
                            "host_country": "India",
                            "name": "UNDER SECRETARY OF KERALA LEGISLATIVE ASSEMBLY",
                            "description": "UNDER SECRETARY OF KERALA LEGISLATIVE ASSEMBLY",
                            "type": "PEP",
                            "url": "http://www.niyamasabha.nic.in/index.php/contact/contact_legislature_secretariat"
                        },
                        "comment": ""
                ...
                try:
                    get_last_name = htmlhelper.collecturl(go, "<b>","</b>")
                    print(get_last_name)
                    print("kj")
                except:
                    print("hi")
